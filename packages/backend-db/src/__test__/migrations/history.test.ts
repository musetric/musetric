...
const expectedFingerprint = [
  ...
  "table ProcessingError CREATE TABLE ProcessingError ( projectId INTEGER NOT NULL, step TEXT NOT NULL CHECK (step IN ('separation', 'transcription', 'rhythm', 'key', 'chords')), message TEXT NOT NULL, PRIMARY KEY (projectId, step), FOREIGN KEY (projectId) REFERENCES Project(id) ON DELETE CASCADE )",
